...
use crate::editor::{
    cleanup_appmd_editor, DocumentOutline, EditorWidget, FindReplacePanel, Minimap,
...
impl AppMDApp {
    ...
    pub(crate) fn render_central_panel(
            ...
            if let TabKind::Special(special_kind) = active_tab_kind {
                ...
                if let Some(store) = self.state.page_store.as_ref() {
                    ...
                    let actions = self.page_editor.show(
                        ...
                        store,
                        &page_id,
                        &mut self.state.page_editor,
                        is_dark,
                    );
                    for delete_id in actions.delete_blocks {
                        let _ = store.delete_block(&delete_id);
                    }
                    for create in actions.create_blocks {
                        let _ = store.create_block(
                            &create.page_id,
                            create.block_type.to_db_string(),
                            &create.content,
                            None,
                            None,
                        );
                    }
                    for update in actions.update_content {
                        let _ = store.update_block_content(&update.block_id, &update.content);
                    }
                    for update in actions.update_type {
                        let _ = store.update_block_type(&update.block_id, update.block_type.to_db_string());
                    }
                    for update in actions.update_props {
                        let _ = store.update_block_props(&update.block_id, &update.props);
                    }
                }
            } else {
                        ...
                        tab_info
                {
                    match view_mode {
                        ViewMode::Raw => {
                            ...
                            // Raw mode: AppMDEditor owns undo via EditHistory
                            // â€” no central-panel snapshot needed.
                            ...
                            if let Some(tab) = self.state.active_tab_mut() {
                                ...
                                // NOTE: Fold toggle is handled internally by AppMDEditor and synced
                                ...
                                if editor_output.fold_toggle_line.is_some() {
                                    // Fold state already synced from AppMDEditor to Tab in widget.rs
                                    log::debug!(
                                ...
                                if editor_output.changed {
                                    ...
                                    // AppMDEditor records its own undo ops â€” no
                        ...
                        ViewMode::Split => {
                            ...
                            if structured_type.is_some() {
                                ...
                                // Split left pane is Raw (AppMDEditor) â€” no
                                ...
                                if let Some(tab) = self.state.active_tab_mut() {
                                    ...
                                    if editor_output.changed {
                                        // AppMDEditor records its own undo ops.
                                        if folding_enabled {
                                            tab.mark_folds_dirty();
                                        }
                                ...
                                if sync_scroll_enabled && !preview_line_mappings.is_empty() {
                                    ...
                                    if is_scrolling {
                                        // Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡Î“Ã¶Ã‡
                                        ...
                                        if mouse_over_editor {
                                            if let Some(ed_offset) = editor_scroll_offset {
                                                ...
                                                // Sync editor Î“Ã¥Ã† preview (user scrolling editor)
                                            ...
                                            if let Some(pv_offset) = preview_scroll_offset {
                                                ...
                                                // Sync preview Î“Ã¥Ã† editor (user scrolling preview)
                        ...
                        ViewMode::Rendered => {
                            ...
                            if let Some(file_type) = tabular_type {
                                ...
                                if let Some(tab) = self.state.active_tab_mut() {
                                    ...
                                    // Store line mappings for scroll sync (source_line Î“Ã¥Ã† rendered_y)
        ...
        // Commands are NOT dispatched here during render â€” they are stored in
