...
fn icon_for_command(cmd: ShortcutCommand) -> &'static str {
    use crate::ui::phosphor_icons::{
        ARROW_CLOCKWISE, ARROW_COUNTER_CLOCKWISE, ARROW_DOWN, ARROW_LEFT, ARROW_RIGHT, ARROW_UP,
        ARROWS_IN, BOOKMARKS, BRACKETS_CURLY, CARET_DOWN, CARET_RIGHT, CARET_UP, CLIPBOARD, CODE,
        COLUMNS, CORNERS_OUT, DESKTOP, EXPORT, EYE, FILE_MAGNIFYING_GLASS, FILE_PDF,
        FILE_PLUS, FILE_TEXT, FLOPPY_DISK, FOLDERS, GEAR, GLOBE, IMAGE, INFO, LIGHTNING, LINK,
        LIST, LIST_BULLETS, LIST_CHECKS, LIST_NUMBERS, MAGNIFYING_GLASS, MAGNIFYING_GLASS_MINUS,
        MAGNIFYING_GLASS_PLUS, MINUS, NOTE_PENCIL, PALETTE, PENCIL, PIPE, PLUS, PRINTER, SCROLL,
        TERMINAL_WINDOW, TEXT_B, TEXT_H_ONE, TEXT_ITALIC, TEXT_T, TRASH, TREE, X,
    };
